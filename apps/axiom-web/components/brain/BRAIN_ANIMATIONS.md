...
The brain graph animation system enhances Axiom's visualization with smooth, performant Framer Motion animations for knowledge graph traversal, evidence highlighting, and research mode narratives.
...
- `motion` (Framer Motion v12.38.0) - Already installed in `axiom-web`
- React 19.2.3+
