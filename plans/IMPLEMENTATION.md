...
| M13 | **Seedling + Feed** — always-on quantized local model, news-comet ingestion, growth stages | 🌱 | In progress | [`plans/seedling-and-feed/plan.md`](seedling-and-feed/plan.md) | `claude/m13-phase2-seedling-lifecycle` | 2026-04-24 | M01 |
