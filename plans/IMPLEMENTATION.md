...
| M02 | **Constellation 2D refactor** — retire 3D sphere, 2D archetype dive (ADR 0006) | 🌌 | In progress | [`plans/constellation-2d-refactor/plan.md`](constellation-2d-refactor/plan.md) | `claude/m02-orbital-observatory` (Phase 4) — Phases 0/1/2/3 landed | 2026-04-18 | — |
