...
| M02 | **Constellation 2D refactor** — retire 3D sphere, 2D archetype dive (ADR 0006) | 🌌 | In progress | [`plans/constellation-2d-refactor/plan.md`](constellation-2d-refactor/plan.md) | `claude/m02-closeup-archetype` (Phase 3 scaffold) — Phases 0/0.3/1/2 landed | 2026-04-18 | — |
