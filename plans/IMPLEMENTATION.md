...
| M17 | **Network audit** — outbound call panel, per-provider block, offline proof | 🔧 | In progress | [`plans/network-audit/plan.md`](network-audit/plan.md) | Phases 1-4 landed (`6aeee97`); `claude/m17-phase5a-routes` working Phase 5a — Litestar routes + real settings reader (UI + prove-offline + CSV export in Phase 5b/5c) | 2026-04-20 | — |
